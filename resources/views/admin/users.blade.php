                ...
                <form action="{{ route('update.user.role', $user->id) }}" method="post">
                  ...
                  <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#editUserRoleModal{{ $user->id }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                      <path d="M14.207 1.293a1 1 0 0 1 0 1.414L3.414 14.207a1 1 0 0 1-1.414-1.414L12.793 1.293a1 1 0 0 1 1.414 0zM3 13V15h2l9-9-2-2L3 13z"/>
                      <path fill-rule="evenodd" d="M15.854 2.146a.5.5 0 0 0 0-.708l-1-1a.5.5 0 0 0-.708 0L13 1.293 14.707 3l1-1a.5.5 0 0 0 0-.708zM12 4l1.5-1.5L2 14v1h1L12 4z"/>
                  </svg>
                  </button>
              </form>
                </td>
